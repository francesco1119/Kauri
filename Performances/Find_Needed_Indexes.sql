/* 
Find needed indexes :
https://dba.stackexchange.com/questions/18943/tools-for-identifying-needed-indexes/275595#275595

TODO:
Add GREATEST in the ORDER BY to highlight a priority 
*/
...
SELECT db.[name] AS [DatabaseName]
    ...
    ,gs.[user_seeks] * gs.[avg_total_user_cost] * (gs.[avg_user_impact] * 0.01) AS [IndexAdvantage]
	 ...
	 ,[avg_system_impact]
	 ,gs.[user_seeks] * gs.[avg_total_user_cost] * (gs.[avg_user_impact] * 0.01) ) AS GreatestBalance */
